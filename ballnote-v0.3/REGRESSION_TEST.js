...
`);
  ...
  equal(r.after.second, 'p2', 'first-base runner steals second');
  equal(r.after.third, 'p1', 'second-base runner steals third');
  ...
  equal(r.after.p1Last, 'third', 'BOX p1 advance');
  equal(r.after.p2Last, 'second', 'BOX p2 advance');
  equal(r.undone.first, 'p2', 'Undo restores first runner');
  equal(r.undone.second, 'p1', 'Undo restores second runner');
